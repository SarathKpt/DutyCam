...
import com.dutycam.app.analyzer.QRAnalyzer
import com.dutycam.app.ktx.markAs16by9Layout
import com.dutycam.app.ktx.markAs4by3Layout
import com.dutycam.app.ui.activities.CaptureActivity
import com.dutycam.app.ui.activities.MainActivity
import com.dutycam.app.ui.activities.MoreSettings
import com.dutycam.app.ui.activities.SecureActivity
import com.dutycam.app.ui.activities.SecureMainActivity
import com.dutycam.app.ui.activities.VideoCaptureActivity
import com.dutycam.app.ui.activities.VideoOnlyActivity
import com.dutycam.app.ui.showIgnoringShortEdgeMode
import com.dutycam.app.util.edit
...
class CamConfig(private val mActivity: MainActivity) {
    ...
    object SettingValues {
        ...
        object Default {
            ...
            const val COMPANY_NAME = "DutyCam"
    ...
    var companyName: String
        get() = commonPref.getString(SettingValues.Key.COMPANY_NAME, SettingValues.Default.COMPANY_NAME)!!
        set(value) {
            commonPref.edit().putString(SettingValues.Key.COMPANY_NAME, value).apply()
        }
...
//        }
    ...
    fun migrateFromLegacyPhotoQuality() {
        ...
        if (commonPref.contains(SettingValues.Key.EMPHASIS_ON_QUALITY)) {
            ...
            if (!commonPref.contains(SettingValues.Key.COMPANY_NAME)) {
                companyName = SettingValues.Default.COMPANY_NAME
            }
