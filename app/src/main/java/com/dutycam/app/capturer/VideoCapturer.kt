...
import com.dutycam.app.VIDEO_NAME_PREFIX
...
class VideoCapturer(private val mActivity: MainActivity) {
    ...
    fun startRecording() {
        ...
        val dateString = SimpleDateFormat("ddMMyy_HHmmss", Locale.US).format(Date())
        val fileName = "${camConfig.companyName}.DC_" + dateString + videoFileFormat
