package com.dutycam.app.capturer
...
import com.dutycam.app.IMAGE_NAME_PREFIX
import com.dutycam.app.ITEM_TYPE_IMAGE
import com.dutycam.app.capturer.ImageSaverException.Place
import com.dutycam.app.clearExif
import com.dutycam.app.fixExif
import com.dutycam.app.util.ImageResizer
import com.dutycam.app.util.executeIfAlive
import com.dutycam.app.util.getTreeDocumentUri
import com.dutycam.app.util.removePendingFlagFromUri
...
const val DEFAULT_MEDIA_STORE_CAPTURE_PATH = "DCIM/WorkMedia"
...
) : ImageCapture.OnImageCapturedCallback()
{
    ...
    private fun dateString() =
        SimpleDateFormat("ddMMyy_HHmmss", Locale.US).format(captureTime)

    private fun fileName(): String {
        return "$companyName.DC_" + dateString() + imageFileFormat
    }
